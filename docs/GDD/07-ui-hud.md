...
|---|---|---|
| Health Bar | Top left | Numeric health bar, see [04-health-save-system.md](04-health-save-system.md) 5.1. Bar is Canvas, the number is an HTML overlay element - see [10-technical-architecture.md](10-technical-architecture.md) 11.8.1 |
| Prisma Bar | Top left, directly below Health Bar | Shield display, see [03-mechanics.md](03-mechanics.md) 4.5. Same Canvas-bar + HTML-number split as the Health Bar |

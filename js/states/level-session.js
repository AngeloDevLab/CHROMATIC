...
import { GHOST_FRAME_SIZE } from '../mechanics/death-sequence.js';
 ...
 * boss-state.js's arena-sizing) before the real LevelSession builds its own.
 ...
 * names enemy-roster.js uses to actually spawn a boss.
 * @param {AssetLoader} assets - Loader to read level JSON/tilesets from.
...
export class LevelSession {
    ...
    /**
     * Refreshes the player's HP/Shield HTML labels (level-session-setup.js's

...
import { MenuButtons } from '../ui/menu-buttons.js';
import { Panel } from '../ui/panel.js';
import { buildSettingsBody, wireSettingsPanel } from '../ui/settings-panel.js';
import { buildInfoBody } from '../ui/info-panel-content.js';
...
export class MenuState extends State {
     ...
     * already loaded by loading-state.js), Legal Notice, Privacy Policy.
     */
    _openInfo() {
     ...
     * how-to-play-panel.js's own comment on why it takes an injected Panel).
     */
    _openHowToPlay() {
